# Train SARSA agents across feature sets and fees.
...
OUTPUT_DIR = str(PROJECT_ROOT / 'experiments' / 'sarsa')
AGENTS_DIR = str(PROJECT_ROOT / 'experiments' / 'sarsa' / 'agents-bugfix')
LOGS_DIR = str(PROJECT_ROOT / 'experiments' / 'sarsa' / 'logs-bugfix')
...
def train_single_agent(
    ...
    agent_id = f"sarsa_{feature_set_name}_{fee_str}_{penalty_str}"
...
def main() -> pd.DataFrame:
    ...
    results_path = f"{OUTPUT_DIR}/results_sarsa.csv"
